flectra.define('icey_dashboard.Dashboard', function (require) {
    "use strict";
    ...
    var HrDashboard = Widget.extend(ControlPanelMixin, {
        template: "icey_dashboard.HrDashboardMain",
        events: {
        ...
        start: function() {
            ...
            .then(function (result) {
                ...
                $('.o_hr_dashboard').prepend(QWeb.render('iceyLoginEmployeeDetails', {widget: self}));
