...
'use strict';
    ...
    sAnimation.registry.form_builder_send = sAnimation.Class.extend({
        ...
        send: function (e) {
            ...
            if (this.$target.data('model_name') == 'hr.applicant') {
                ...
                .then(function (result_data) {
                    ...
                    if (!result_data.id) {
                        ...
                        $("input[name='x_partner_id']").val(result_data.partner_id)
                        $("input[name='x_applicant_id']").val(result_data.id)
                        setTimeout(function(){
                            ...
                            if (success_page) {
                                ...
                                $(".form_other_details").trigger("click");
                            }
                            else {
